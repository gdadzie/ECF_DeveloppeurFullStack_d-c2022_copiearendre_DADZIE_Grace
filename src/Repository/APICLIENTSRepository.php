...
class APICLIENTSRepository extends ServiceEntityRepository
{
   ...
   public function findByExampleField($value): array
    {
        return $this->createQueryBuilder('apiclients')
            ->andWhere('apiclients.client_name = :val')
            ->setParameter('val', $value)
            ->orderBy('apiclients.client_name', 'ASC')
            ->setMaxResults(10)
            ->getQuery()
            ->getResult()
       ;
    ...
    {
        return $this->createQueryBuilder('apiclients')->andWhere('apiclients.client_name = :val')
            ->setParameter('val', $value)
            ->getQuery()
            ->getOneOrNullResult()
        ;
